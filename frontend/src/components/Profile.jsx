            ...
            <div className="flex gap-2">
              ...
              {isEditing && (
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-emerald-500 to-green-500 text-white rounded-lg hover:shadow-md hover:shadow-emerald-200 transition-all"
                >
                  <Save size={18} />
        ...
        <div className="p-6">
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-r from-emerald-500 to-green-500 rounded-2xl p-6 text-white">
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold">{new Date(user?.created_at).toLocaleDateString('en-US', { month: 'long', year: 'numeric' }) || 'January 2024'}</p>
                </div>
              </div>
          ...
          <div className="flex border-b border-emerald-200 mb-6">
            ...
            <button
              ...
              className="flex-1 py-3 text-center font-medium text-gray-600 hover:text-emerald-600 transition-colors flex items-center justify-center gap-2"
            >
              <Trophy size={18} />
                  ...
                  {enrollments.map((enrollment, index) => (
                    ...
                    >
                      ...
                      <div className="mt-3 flex items-center justify-between">
                        ...
                        <span className={`text-sm font-bold ${enrollment.progress === 100
                            ? 'text-emerald-700'
                            : 'text-amber-600'
                          }`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {achievements.slice(0, 3).map((achievement, index) => (
                  <div
                    ...
                    className="bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-200 rounded-xl p-4 hover:border-amber-300 hover:shadow-sm transition-all cursor-pointer"
                    onClick={handleViewAchievements}
                  >
                    <div className="flex items-center gap-3">
          ...
          <div className="mt-8 pt-6 border-t border-emerald-200">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <button
                onClick={handleEditProfile}
                className="inline-flex items-center justify-center gap-2 bg-white border-2 border-emerald-200 text-emerald-700 px-4 py-3 rounded-lg font-bold hover:bg-emerald-50 hover:border-emerald-500 transition-all"
              >
                <Edit size={18} />
                Edit Profile
              </button>
              <button
                onClick={handleViewAchievements}
                className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white px-4 py-3 rounded-lg font-bold hover:shadow-md hover:shadow-amber-200 transition-all"
              >
                <Trophy size={18} />
                View Achievements
              </button>
              <button
                onClick={handleViewSettings}
                className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-4 py-3 rounded-lg font-bold hover:shadow-md hover:shadow-blue-200 transition-all"
              >
                <SettingsIcon size={18} />
                Settings
              </button>
